        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="number" class="form-control" name="id" value="${id}" id="id" required>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="datedebut" value="${datedebut}"
                               id="datedebut"
                               required>
                    </div>
                </div>
            ...
            <div class="panel-footer clearfix">
                <div class="form-group">
                    <button class="btn btn-lg btn-default" type="submit" name="editer" value="Editer">Editer</button>
