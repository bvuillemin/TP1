...
<form class="form-horizontal" method="post" action="Controleur" onsubmit="return verif();">
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" name="datedebut" value="${stage.datedebut}" id="datedebut">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" name="nbinscrits" value="${stage.nbinscrits}" id="nbinscrits">
            </div>
        </div>
